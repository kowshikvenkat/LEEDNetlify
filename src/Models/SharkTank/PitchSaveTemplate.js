...
function PitchSaveTemplate({val,userid}) {
...
axios.post("https://leednetlifybackend.onrender.com/savepitchST",{
    id:userid,
    pitchid:pitchid
})
setdisablelike(false)
...
<button className={saved.includes(val["_id"])? 'btn btn-light shadow-sm m-1':'btn btn-light shadow-sm m-1'}  disabled={disablelike} onClick={()=>savepitch(val["_id"])} >
...
export default PitchSaveTemplate
