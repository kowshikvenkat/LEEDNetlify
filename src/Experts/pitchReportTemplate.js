...
function PitchReportTemplate({id,email,val,userid}){    
 ...
 {opencomment==val['_id']&&<> <hr /> {email=="kowshik.20ei@kct.ac.in"&& <div>
           ...
           <b>{val['comment']['expert3']}</b>
            ...
            <div className="d-flex align-items-center flex-column">
                 <div className='w-75'>
        <h3 style={{fontWeight:600}} className='text-danger'>YOUR REPORT</h3>
           {val['report'].map((value,index)=>{
              let expert  =email=="kowshik.20ei@kct.ac.in"?0:email == "jeevankumar.20ei@kct.ac.in" ? 1 : 2;
           return <div  style={{flex:0.3,border:'1px solid black',marginBottom:5,borderRadius:5,background:'#fcfbf8',minWidth:'150px'}}>{
            value['expert']==expert&&<><p>Problem : {value['one']}</p>
   ...
   export default PitchReportTemplate;